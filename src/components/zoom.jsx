...
const ZoomMeeting = ({
  ...
  <div className="w-56 p-6 mx-auto my-4 text-center bg-white border border-gray-300 rounded shadow-lg">
    ...
    {downloadLink
      ? (
        <div>
          <a href={downloadLink} download className="flex items-center justify-center p-1 mt-4 text-sm font-bold text-white bg-teal-600 rounded hover:bg-teal-700">
