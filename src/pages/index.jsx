...
const Home = ({ posts }) => (
  <div>
    ...
    <details className="my-4">
      ...
      <div className="pl-4">
        <p>
          ...
          for the first time.{' '}
          <em>
            It is not necessary for you to create an account with Zoom to join a
            meeting.
          </em>
        </p>
        <p>
        ...
        <ol>
          <li>
            ...
            directed to open the application or download the application to your
            computer. You can also download here:
            <a
          ...
          <li>
            <p>
              <strong>Join by Phone:</strong> Call in with the phone number and
              Meeting ID.
            </p>
            <ul>
              <li>
        ...
        <div className="px-6 pt-4 pb-6 mt-4 bg-gray-100 border border-gray-300 rounded-lg">
          <div>
            <h4 className="mb-1 font-bold ">Having Technical Issues?</h4>
            <p>
              Zoom has an excellent online support website with video tutorials
              that can help you get setup:{' '}
    ...
    <p>
      ...
      Other forms of witnessing that do not require being in close contact with
      groups of people, such as letter writing, is encouraged.
    </p>
